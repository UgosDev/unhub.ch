...
export const ArchivioChLogoIcon: FC<ScansioniChLogoIconProps> = ({ lightFill, darkFill, ...props }) => (
  <svg id="Livello_5" data-name="Livello 5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1034.12 768.26" {...props}>
    <polygon fill={lightFill || "var(--logo-light-fill, #fc7d6e)"} points="738.49 .08 442.82 .08 590.66 256.07 590.62 256.07 590.62 256.11 590.66 256.14 886.32 768.26 886.35 768.19 886.32 768.19 1034.12 512.2 1034.12 512.17 886.32 256.14 738.49 .08"/>
    <polygon fill={darkFill || "var(--logo-dark-fill, #fe3f27)"} points="442.78 0 294.95 256.06 147.11 512.12 147.49 512.73 0 768.18 294.95 768.18 442.78 512.12 590.61 256.09 590.61 256.06 442.78 .07 442.81 .07 442.78 0"/>
  </svg>
);
...
export const PolizzeChLogoIcon: FC<ScansioniChLogoIconProps> = ({ lightFill, darkFill, ...props }) => (
  <svg id="Livello_5" data-name="Livello 5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 768.18 1478.31" {...props}>
    <polygon fill={darkFill || "var(--logo-dark-fill, #61f5fe)"} points="768.18 443.49 768.18 739.16 256.06 443.49 .03 295.66 .03 0 256.06 147.83 256.09 147.83 512.12 295.66 768.18 443.49"/>
    <polygon fill={lightFill || "var(--logo-light-fill, #c0fbfc)"} points="768.18 739.16 512.12 886.99 256.06 1034.82 0 1182.69 0 1182.65 256.06 739.16 512.12 591.33 768.18 739.16"/>
    <polygon fill={darkFill || "var(--logo-dark-fill, #61f5fe)"} points="256.06 1034.82 256.06 1478.31 0 1478.31 0 1182.69 256.06 1034.82"/>
  </svg>
);
...
export const DisdetteChLogoIcon: FC<ScansioniChLogoIconProps> = ({ lightFill, darkFill, ...props }) => (
  <svg id="Livello_5" data-name="Livello 5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" {...props}>
    <polygon fill={lightFill || "var(--logo-light-fill, #86efac)"} points="100,500 250,350 450,550 300,700" />
    <polygon fill={darkFill || "var(--logo-dark-fill, #15803d)"} points="300,700 450,550 900,100 750,250" />
  </svg>
);
...
// FIX: Add UnHubChWordmarkIcon export
export const UnHubChWordmarkIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 240 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="0" y="30" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="30" fontWeight="bold" fill="currentColor">UnHub.ch</text>
    </svg>
);
...
// FIX: Add HeartIcon and WhatsappIcon exports
export const HeartIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
    </svg>
);

export const WhatsappIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M19.05 4.91A9.816 9.816 0 0 0 12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38c1.45.79 3.08 1.21 4.79 1.21 5.46 0 9.91-4.45 9.91-9.91a9.874 9.874 0 0 0-2.9-7.01zM12.04 20.13c-1.48 0-2.92-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.264 8.264 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24 2.2 0 4.23.86 5.82 2.45s2.45 3.62 2.45 5.82c0 4.54-3.7 8.24-8.24 8.24zm4.52-6.16c-.25-.12-1.47-.72-1.7-.81-.23-.08-.39-.12-.56.12-.17.25-.64.81-.78.97-.14.17-.28.18-.52.06-1.09-.5-2.04-1.18-2.8-1.95-.59-.59-1.04-1.32-1.16-1.55-.12-.23-.01-.36.11-.47.1-.1.23-.26.34-.39.09-.11.14-.19.22-.31.08-.12.04-.23-.04-.35-.08-.12-1.04-2.51-1.42-3.44-.37-.9-.75-.77-1.02-.78-.25-.01-.52-.01-.8-.01-.27 0-.7.1-.96.36-.26.26-1.02.99-1.02 2.41s1.04 2.8 1.19 3c.14.2 2.08 3.25 5.09 4.52.75.32 1.34.51 1.79.65.69.21 1.31.18 1.8.11.55-.07 1.76-1.03 2.01-2.04.25-1 .25-1.85.18-2.04-.08-.18-.28-.29-.53-.4z"></path></svg>
);
